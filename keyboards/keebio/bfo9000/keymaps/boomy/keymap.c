...
//    ├────┼───────────────────┼─────────────────┼─────────────────┼─────────────────┼─────────────────┼─────────────────┼───────────────┼───────┤   ├──────┼──────────────┼───────────────┼─────────────────┼─────────────────┼─────────────────┼─────────────────┼───────────────┼────┤
//    │ no │        no         │       no        │      lctl       │      lalt       │      lgui       │ MT(MOD_LSFT, `) │ LT(_NAV, tab) │ U_ARW │   │  no  │ LT(_FN, ent) │ LT(_SYM, spc) │  OSM(MOD_LCTL)  │        [        │        ]        │       no        │      no       │ no │
//    └────┴───────────────────┴─────────────────┴─────────────────┴─────────────────┴─────────────────┴─────────────────┴───────────────┴───────┘   └──────┴──────────────┴───────────────┴─────────────────┴─────────────────┴─────────────────┴─────────────────┴───────────────┴────┘
[_BASE] = LAYOUT_bfo9000(
  ...
  XXXXXXX , KC_TAB                  , KC_Q               , KC_W               , KC_E               , KC_R               , KC_T                   , KC_LCBR          , XXXXXXX ,     XXXXXXX , KC_RCBR         , KC_Y             , KC_U               , KC_I               , KC_O               , KC_P                  , KC_MINS             , XXXXXXX,
  XXXXXXX , MT(MOD_LGUI, KC_ESCAPE) , MT(MOD_LCTL, KC_A) , MT(MOD_LALT, KC_S) , MT(MOD_LGUI, KC_D) , MT(MOD_LSFT, KC_F) , KC_G                   , KC_LPRN          , XXXXXXX ,     KC_BSPC , KC_RPRN         , KC_H             , MT(MOD_LSFT, KC_J) , MT(MOD_RGUI, KC_K) , MT(MOD_LALT, KC_L) , MT(MOD_RCTL, KC_SCLN) , KC_QUOTE            , XXXXXXX,
  ...
  XXXXXXX , XXXXXXX                 , XXXXXXX            , KC_LCTL            , KC_LALT            , KC_LGUI            , MT(MOD_LSFT, KC_GRAVE) , LT(_NAV, KC_TAB) , U_ARW   ,     XXXXXXX , LT(_FN, KC_ENT) , LT(_SYM, KC_SPC) , OSM(MOD_LCTL)      , KC_LBRC            , KC_RBRC            , XXXXXXX               , XXXXXXX             , XXXXXXX
),
...
[_FN] = LAYOUT_bfo9000(
  ...
  KC_TRNS , KC_TRNS , KC_APPLICATION , KC_F6   , KC_F5   , KC_F4   , KC_F11  , KC_TRNS , KC_TRNS ,     KC_TRNS , KC_TRNS , KC_LSFT , KC_LCMD , KC_LOPT , KC_LCTL , KC_TRNS , KC_TRNS , KC_TRNS,
